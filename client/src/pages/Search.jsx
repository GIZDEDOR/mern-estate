        ...
        <div className='p-7 border-b-2 sm:border-r-2 md:min-h-screen'>
            <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                ...
                <div className='flex items-center gap-2'>
                    ...
                    >
                        <option value='regularPrice_desc'>Цена: сначала дорогие</option>
                        <option value='regularPrice_asc'>Цена: сначала дешёвые</option>
        ...
        <div className='flex-1'>
            ...
            <div className='p-7 flex flex-wrap gap-4'>
                {!loading && listings.length === 0 && (
                    <p className='text-xl text-slate-700'>Объектов не найдено!</p>
                )
                }
                {loading && (
                    <p className='text-xl text-slate-700 text-center w-full'>Загрузка...</p>
                )}
